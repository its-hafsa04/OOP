//Create an abstract base class BankAccount with a pure virtual function calculateInterest(). Derive two classes 
//SavingsAccount and CurrentAccount from BankAccount and implement calculateInterest() accordingly.
#include <iostream>
using namespace std;
class BankAccount {
public:
